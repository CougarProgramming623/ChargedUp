...
void AutoLock::Execute() {    
    ...
    std::abs(r.getAngle()) > 90 ? m_Theta = 180: m_Theta = 0;
    auto pidVal = m_ThetaController.Calculate(units::radians_t{Deg2Rad(r.getAngle())}, (m_Theta))
    ...
    frc::ChassisSpeeds speeds = frc::ChassisSpeeds::FromFieldRelativeSpeeds(
            ...
            units::radians_per_second_t(m_ThetaController(0.5, 0.5, 0.5)),
